...
Bouncy.Level3.prototype = { //****************************************************
    
    preload: function(){
        this.load.image('space', 'assets/space.png');
        this.load.tilemap('level_3', 'assets/Field.json', null, Phaser.Tilemap.TILED_JSON);//the JSON file stored in assets/**************************************
    ...
    create: function(){
        ...
        star = this.add.sprite(620, 600, 'star');
        ...
        cannon = this.add.sprite(60, 300, 'cannon');//*****************************************************************
        ...
        var objLayer4 = this.physics.p2.convertCollisionObjects(map, "Object Layer 4", true);
        var objLayer5 = this.physics.p2.convertCollisionObjects(map, "Object Layer 5", true);
    ...
    captureStar: function(){
        shootSound.stop();
        this.state.start('Level4', true, false, 0, numShots);
    },
